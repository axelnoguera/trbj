...
<head>
    ...
    <meta name="description" content="INROM es una empresa mexicana ubicada en Aguascalientes. Nos dedicamos a la fabricación de tarimas de madera, cajas de carton y productos de tela para empaque.">
    <meta name="keywords" content="tarimas,empaques,carton,sms,telasnotejidas,filtracion,ropamedica,embalaje,madera,bolsas,proteccion,nom#144semarnat,bolsadetela,fundadetela,bolsaSMS,proteccióndetela">
    <title>inrom  - Fabricación de Tarimas y Empaques en Aguascalientes</title>
    <link rel="stylesheet" href="style.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Pathway+Gothic+One&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap" rel="stylesheet">
</head>
<body>
    <main>
        <section class="section1">
            ...
            <section class="sub-section1">
                <h1 tabindex="2">TARIMAS Y EMPAQUES</h1>
                <p tabindex="3">Tenemos todo lo que necesitas para el manejo de materiales.
                <strong>Fabricamos tarimas de madera</strong> para uso nacional y de exportación certificadas
                bajo la norma <strong>NOM-#-144-SEMARNAT</strong>, bolsa protectora de tela no tejida para la
                protección de piezas plásticas y de cristal, empaques de cartón para el resguardo de tus productos.</p>

                <a href="https://wa.link/i7sp8p" rel="nofollow" target="_blank" tabindex="4" aria-label="boton acceso a whatsapp para cotizacion">Solicite una cotización</a>
            </section>
        </section>


        <section class="section2" id="info-inrom">
            <p tabindex="5">
                ¡Somos <strong>proveedores</strong> de tarimas de madera líderes en Aguascalientes!<br>
                INROM se especializa en la fabricación de tarimas de madera, <strong>cajas de cartón</strong>
                y empaques SMS de alta calidad para envíos o almacenamiento, fabricados a su medida.
            </p>
        </section>
        ...
        <section class="section3">
            ...
            <article>
                <div class="caja-img">
                    ...
                    <a class="boton" href="producto1/index.html" tabindex="9" aria-label="boton para ver producto">ver</a>
            </article>
            ...
            <article>
                <div class="caja-img">
                    ...
                    <a class="boton" href="producto2/index.html" tabindex="12" aria-label="boton para ver producto">ver</a>
            ...
            <article>
                <div class="caja-img">
                    ...
                    <a class="boton" href="producto3/index.html" tabindex="15" aria-label="boton para ver producto">ver</a>
            </article>
